...
public class AuthController {
        ...
        public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO reqLoginDTO)
                ...
                User currentUser = this.userServiceImpl.getUserByUserName(reqLoginDTO.getUsername());
                if (currentUser != null) {
                ...
                this.userServiceImpl.updateUserToken(refresh_token, reqLoginDTO.getUsername());
        ...
        public ResponseEntity<ResCreateUserDTO> register(@Valid @RequestBody User u)
                ...
                boolean isEmailExist = this.userServiceImpl.isEmailExist(u.getEmail());
                if (isEmailExist) {
                ...
                User newUser = this.userServiceImpl.handleCreateUser(u);
                return ResponseEntity.status(HttpStatus.CREATED)
                                .body(this.userServiceImpl.convertToResCreateUserDTO(newUser));
        }
        ...
        public ResponseEntity<ResLoginDTO> getRefreshToken(
                ...
                User currentUser = this.userServiceImpl.getUserByRefreshTokenAndEmail(refresh_token, email);
                ...
                // update user refresh token
                this.userServiceImpl.updateUserToken(new_refresh_token, email);
